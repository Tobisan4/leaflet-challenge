...
function createMap(earthquakes) {
    ...
    // Store our API endpoint as queryUrl.
    let queryUrl2 = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_plates.json";
    ...
    function createFeatures2(plateData) {
        ...
        function onEachFeature2(feature, layer) {
            layer.bindPopup(`<h3><b>Plate Name:</b> ${feature.properties.PlateName}</h3>`);
        }
        // Create a GeoJSON layer that contains the features array on the plateData object.
        // Run the onEachFeature function once for each piece of data in the array.
        let plates1 = new L.geoJSON(plateData, {
